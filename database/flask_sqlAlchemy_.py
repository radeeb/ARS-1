...
class Page(Base.Model):
    ...
    visits = Base.relationship('WebsiteVisits', backref="page", lazy="dynamic") #one to many relationship with website visits
    keywords = Base.relationship('Page_Keyword', backref="page", lazy="dynamic")
